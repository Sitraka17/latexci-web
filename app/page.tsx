...
const TOOLS = [
  ...
  { href: "/tools/symbols",        icon: "∑",  label: "Symbol Search",   tag: "New",     color: "#14b8a6",
    desc: "Search 200+ symbols by name, command, or Unicode. Live KaTeX preview, copy in one click." },
