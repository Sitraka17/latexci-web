...
const PLANS = [
  ...
  },
  {
    ...
    name: "Pro",
    monthlyPrice: 9,
    annualPrice: 4,    // $49/yr ÷ 12 ≈ $4.08, shown as 4
    annualTotal: 49,
    ...
    badge: "Most Popular",
    description: "For PhD students, postdocs, and independent researchers.",
    cta: "Start Pro",
    ctaHref: null,
    ctaExternal: false,
    highlight: true,
  ...
  },
  {
    ...
    name: "Lab",
    monthlyPrice: 19,
    annualPrice: 17,   // $199/yr ÷ 12 ≈ $16.6, shown as 17
    annualTotal: 199,
    ...
    badge: "Teams",
    description: "For PI groups and research labs — 5 seats, one invoice.",
    cta: "Start Lab",
    ctaHref: null,
    ctaExternal: false,
    highlight: false,
